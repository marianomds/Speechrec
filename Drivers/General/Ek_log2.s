...
; log2_16q16:   32 bit base 2 logarithm function for ARM Cortex-M3      KEIL  
; --------------------------------------------------------------------------
...
; int log2_16q16(unsigned int x);   

; input 16q16 unsigned   1/65536 to 65535+65535/65536  
; output 5q27 signed   -15.99999 to 15.99999
; log2_16q16(0x80800000)=0x780b81b7   e.g. log2(32896)= 15.005618505179882049560546875
; log2_16q16(0x0000abcd)= -77230085   e.g. log2(0.67109680175781)= -0.57540897279978
...
log2_16q16
            ...
            lsls r0, r1
            ubfx r3, r0, #0x0F, #0x09
            ubfx r0, r0, #0x18, #0x07
            ldr.w r2, [r12, r0, lsl #0x2]
            mov.w r0, r2, asr #0x03
            ubfx r2, r2, #0x00, #0x0C
            mul r2, r3
            adds.w r0, r2, r0, lsr #0x01
            subs.w r0, r0, r1, lsl #0x1B
